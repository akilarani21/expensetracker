...
import 'package:expense_tracker/select.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 199, 194, 194).withOpacity(0.7),
      ...
      body: Stack(
        children: [
          SingleChildScrollView(
            ...
            child: Container(
              width: screenWidth * 1.5, // Make it larger than the screen for scrolling
              child: Stack(
                children: [
                  Image.asset(
                    'lib/front.jpg',
